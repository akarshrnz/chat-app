...
class _RegisterScreenState extends State<RegisterScreen> {
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    const Text("Join our community today", style: TextStyle(color: Colors.white70, fontSize: 14)),
                    const SizedBox(height: 40),
                    Form(
                      key: _formKey,
                      child: Column(
                        children: [
                          _inputField("Email", emailCtrl, icon: Icons.email, validator: (value) {
                            if (value == null || value.isEmpty) return 'Please enter your email';
                            if (!value.contains('@')) return 'Please enter a valid email';
                            return null;
                          }),
                          const SizedBox(height: 16),
                          _inputField("Password", passCtrl, isPassword: true, icon: Icons.lock, validator: (value) {
                          ...
                          PrimaryButton(
                            ...
                            child: isLoading
                                ? const DotLoader()
                                : const Text("Register Now", style: TextStyle(color: Colors.black, fontSize: 16, fontWeight: FontWeight.bold)),
                          ),
                        ],
                      ),
                    ),
                    ...
                    TextButton(
                      ...
                      child: RichText(
                        text: TextSpan(
                          ...
                          children: [
                            TextSpan(text: "Login", style: TextStyle(color: Colors.tealAccent[400], fontWeight: FontWeight.bold)),
                          ],
                        ),
                      ),
                    ),
  ...
  Widget _socialButton(IconData icon, Color color) {
    return Container(
      ...
      child: IconButton(icon: Icon(icon, color: color, size: 30), onPressed: () {}),
    );
  }
}
